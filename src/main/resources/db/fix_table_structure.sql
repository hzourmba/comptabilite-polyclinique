-- Adapter la structure de la table utilisateurs pour correspondre au modèle Java
USE comptabilite_db;

-- Supprimer complètement la table utilisateurs existante et la recréer
DROP TABLE IF EXISTS utilisateurs;

-- Créer la table utilisateurs avec la structure exacte attendue par le modèle Java
