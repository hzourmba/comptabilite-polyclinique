-- AGGRESSIVE database reset - this will completely wipe and recreate everything
-- Make sure to backup any important data before running this!

-- Drop the entire database and recreate it
DROP DATABASE IF EXISTS comptabilite_db;
CREATE DATABASE comptabilite_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- Create compte table with ONLY the simplified enum values
CREATE TABLE compte (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    entreprise_id BIGINT NOT NULL,
...
-- Insert sample data with ONLY the new enum values
...
-- Insert basic chart of accounts with NEW SIMPLIFIED ENUM VALUES ONLY
...
SELECT 'Database completely reset with correct enum values!' AS status;