-- Corriger les noms de colonnes pour correspondre exactement au modèle Java
USE comptabilite_db;
...
-- Vérifier si la table entreprises a la bonne structure aussi
-- Hibernate s'attend à "entreprises" pas "entreprise"
SHOW TABLES LIKE 'entreprise%';

-- Renommer la table si nécessaire
RENAME TABLE entreprise TO entreprises;
