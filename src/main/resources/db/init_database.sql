-- Complete database initialization script for Comptabilite application
-- This creates the full schema with all necessary tables
...
-- Create compte table with all new fields
CREATE TABLE compte (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    entreprise_id BIGINT NOT NULL,
...
-- Insert basic chart of accounts for France (PCG)
...
-- Insert basic chart of accounts for Cameroun (OHADA)
INSERT INTO compte (entreprise_id, numero, libelle, type_compte, classe_compte, accepte_sous_comptes) VALUES
-- Classe 1 - Comptes de capitaux
